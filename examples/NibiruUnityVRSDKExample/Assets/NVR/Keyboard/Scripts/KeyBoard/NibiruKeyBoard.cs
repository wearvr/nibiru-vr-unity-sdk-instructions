...
public class NibiruKeyBoard {
    ...
    public void OnPressEnter(RaycastHit hit) {
        if (hit.collider.name.Substring(0, 3) == "Key")
        {
            KeyBoardSingle _CKeyBoardSingle = hit.collider.GetComponent<KeyBoardSingle>();
    ...
    public void Dismiss() {
        ...
        {
            keyBoardTransform.position = new Vector3(0, -0.3f, 1);
